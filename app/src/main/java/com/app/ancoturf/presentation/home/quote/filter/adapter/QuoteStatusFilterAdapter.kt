package com.app.ancoturf.presentation.home.quote.filter.adapter
...
class QuoteStatusFilterAdapter(
    private val activity: AppCompatActivity,
    var arrayList: ArrayList<QuoteStatus>,
    var quoteFilterFragment: QuoteFilterFragment
) :
    RecyclerView.Adapter<QuoteStatusFilterAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        quoteFilterFragment.setSelectedStatus(arrayList)
