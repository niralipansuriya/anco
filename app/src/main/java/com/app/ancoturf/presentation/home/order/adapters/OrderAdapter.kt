...
import com.app.ancoturf.presentation.home.order.interfaces.OnUpdate
...
class OrderAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if ((order.orderStatus != null  && !Utility.isValueNull(order.orderStatus.displayName)) && (order.deliveryStatus != null  && !Utility.isValueNull(order.deliveryStatus.displayName))) {
