...
class OrderStatusFilterAdapter(
    private val activity: AppCompatActivity,
    var arrayList: ArrayList<SettingsResponse.Data.OrderStatus>,
    var orderFilterFragment: OrderFilterFragment
) :
    RecyclerView.Adapter<OrderStatusFilterAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        orderFilterFragment.setSelectedOrderStatus(arrayList)
