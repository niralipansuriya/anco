...
class PortfolioDetailUseCase @Inject constructor(private val portfolioRepository: PortfolioRepository) :
    ...
    override fun buildSingle(data: Map<String, Any?>?): Single<BaseResponse<PortfolioDetailResponse>> {
        return portfolioRepository.getPortfolioRepositoryDetail(portfolioId = data?.get(UseCaseConstants.PORTFOLIO_ID) as Int)
    }
}