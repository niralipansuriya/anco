...
class GetCouponsUseCase @Inject constructor(private val cartRepository: CartRepository) :  BaseUseCase<List<CouponDB>>(){

    override fun buildSingle(data: Map<String, Any?>?): Single<List<CouponDB>> {

        return cartRepository.getAllCoupons()
    }
}