package com.app.ancoturf.utils.customeview.seekbar;
...
import static com.app.ancoturf.utils.customeview.seekbar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.app.ancoturf.utils.customeview.seekbar.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    private int progressTop, progressBottom;
    private float progressLeft, progressRight;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        leftSB.onSizeChanged((int) getProgressLeft(), lineCenterY);
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            rightSB.onSizeChanged((int) getProgressLeft(), lineCenterY);
        }
    }
