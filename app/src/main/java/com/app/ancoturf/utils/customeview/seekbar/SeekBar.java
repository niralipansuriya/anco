...
public class SeekBar {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        thumbDrawableId = t.getResourceId(R.styleable.RangeSeekBar_rsb_thumb_drawable, R.drawable.ic_seek_thumb);
    ...
    protected void onDrawIndicator(Canvas canvas, Paint paint, String text2Draw) {
        ...
        int leftOffset = (int) (indicatorRect.width() / 2 - (int) (rangeSeekBar.getProgressWidth() * currPercent) - rangeSeekBar.getProgressLeft() + defaultPaddingOffset);
